...
##  申请[SonaType](https://issues.sonatype.org/secure/WelcomeToJIRA.jspa)网站的用户
...
用你的`SonaType `的账号密码进行登陆后，点击左边的`Staging Repositories`然后根据所写的`Group Id`进行查询。如果在`Staging Repositories`中查找不到你的项目，但是在[Nexus公有库](https://oss.sonatype.org/index.html#welcome)中是可以查找到你的项目的话。
...
在[中央仓库](https://search.maven.org/)中查找就能看到已经上传的Jar包了
...
* [https://blog.csdn.net/i_iphone/article/details/78230057](https://blog.csdn.net/i_iphone/article/details/78230057)
* [发布项目到中央库的一些常见问题](https://blog.csdn.net/qiaojialin/article/details/77659200)
